...
class SourceYahoo:
    ...
    def __init__(self, ticker, stock_prefix, verbosity=0):
        ...
        self.xchange = ticker_seg[-1]
        self.symbol  = '.'.join( ticker_seg[0:-1])

        self._debug( 'setting ticker : '+ self.ticker )
        self._debug( 'xchange : '+ self.xchange )
        self._debug( 'symbol : '+ self.symbol )
